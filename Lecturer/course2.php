<?php
        ...
        $view_users_query="Select * from students WHERE Date = '$sdate' AND CCode = '$codec2'";//select query for viewing users.
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <?php if (!empty($rowly['course2'])) {?>
                        <li class="active"><a href="course2.php"><span class="fa fa-desktop"></span> <?php echo $rowly['course2'] ?></a></li>
                    <?php } ?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="btn-group pull-left">
                                        <!-- Form code begins -->
                                        <form class="form-inline" method="get" action="course2.php" >
